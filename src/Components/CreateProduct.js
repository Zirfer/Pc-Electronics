...
const CreateProduct = () => {
    ...
    const handleRegister = () => {
        if (data !== '') {
            window.alert("Se ha registrado un producto")
            handleClear()
        } else {
    ...
    return (
        <div className="container p-4">
            <h1 className="center" style={{ width: '100%' }}>Nuevo producto</h1>
            <hr />
            <div className="center">
                <div className="row col-md-4" style={{ width: '400px' }}>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="clr"></div>
                        <div className="center">
                            <button type="button" className="col-md-5 btn btn-success" onClick={handleRegister}>Registrar</button>
